(asdf:defsystem "consumer2"
  :version "0.1.0"
  :description "Depends only on consumer1, NOT on natlib directly -- native.nix propagates the search path two hops, unlike prior art's one-hop, name-gated setup hook."
