(asdf:defsystem "matrix-demo-fail"
  :version "0.1.0"
  :description "A system whose test suite always fails, so the matrix can verify that a failure propagates as a non-zero exit under every Lisp implementation."
